...
\end{Verbatim}
    ...
    \hypertarget{plote-num-gruxe1fico-o-desempenho-na-base-de-testes-e-analise-em-qual-ponto-o-tamanho-da-base-de-treinamento-deixa-de-ser-relevante.}{%
...
\end{Verbatim}
    ...
    \hypertarget{qual-uxe9-o-classificador-que-tem-o-melhor-desempenho-com-poucos-dados-1000-exemplos.}{%
...
regressão logística que executou num tempo médio de .16 segundos.
    ...
    \hypertarget{qual-uxe9-o-classificador-que-tem-melhor-desempenho-com-todos-os-dados.}{%
...
mais rápido ao classificar todos os dados
    ...
    \hypertarget{qual-uxe9-o-classificador-uxe9-mais-ruxe1pido-para-classificar-os-58k-exemplos-de-teste.}{%
